...
export const TEACHERS = [
    { id: 1, name: 'Иванова Мария Ивановна', subject: 'Математика', grades: ['Средняя школа (5-9)', 'Старшая школа (10-11)'], lessonRate: 1200 },
    { id: 2, name: 'Петров Петр Петрович', subject: 'Физика', grades: ['Средняя школа (5-9)', 'Старшая школа (10-11)'], lessonRate: 1100 },
    { id: 3, name: 'Сидорова Анна Сергеевна', subject: 'Русский язык', grades: ['Начальная школа (1-4)', 'Средняя школа (5-9)'], lessonRate: 900 },
    { id: 4, name: 'Кузнецов Алексей Дмитриевич', subject: 'Информатика', grades: ['Средняя школа (5-9)', 'Старшая школа (10-11)'], lessonRate: 1300 },
    { id: 5, name: 'Смирнова Елена Владимировна', subject: 'История', grades: ['Средняя школа (5-9)'], lessonRate: 850 },
